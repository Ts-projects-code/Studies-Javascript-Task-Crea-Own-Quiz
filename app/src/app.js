...
function addQuestion() {
    ...
    selectElement.addEventListener('change', function () {
        var _a, _b;
        const optionsContainer = (_a = this.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.options-container');
        const correctAnswerContainer = (_b = this.parentElement) === null || _b === void 0 ? void 0 : _b.querySelector('.correct-answer-container');
...
function addOption(button) {
    var _a;
    const optionsList = (_a = button.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.options-list');
    ...
    updateCorrectAnswerDropdown(button.closest('.question'));
}
function removeOption(button) {
    const optionDiv = button.parentElement;
    const question = optionDiv === null || optionDiv === void 0 ? void 0 : optionDiv.closest('.question');
    optionDiv === null || optionDiv === void 0 ? void 0 : optionDiv.remove();
...
function removeQuestion(button) {
    var _a;
    (_a = button.closest('.question')) === null || _a === void 0 ? void 0 : _a.remove();
}
function saveQuiz() {
    ...
    const questions = Array.from(document.querySelectorAll(".question")).map(el => {
        var _a, _b;
        const questionText = el.querySelector("input[type='text']").value;
        const answerType = el.querySelector("select").value;
        const options = Array.from(el.querySelectorAll(".options-list input[type='text']"))
            .map(input => input.value)
            .filter(value => value.trim() !== '');
        const correctAnswer = (_a = el.querySelector(".correct-answer")) === null || _a === void 0 ? void 0 : _a.value;
        const isRequired = ((_b = el.querySelector(".required-checkbox")) === null || _b === void 0 ? void 0 : _b.checked) || false;
        return {
            questionText,
            answerType,
...
function loadQuizQuestions(quiz) {
    ...
    quizCards.innerHTML = "";
    const questions = (quiz === null || quiz === void 0 ? void 0 : quiz.questions) || [
        {
    ...
    questions.forEach((q, index) => {
        ...
        if (q.correctAnswer) {
            card.setAttribute('data-correct-answer', Array.isArray(q.correctAnswer) ? JSON.stringify(q.correctAnswer) : q.correctAnswer);
        }
        let questionHtml = `
        ...
        if (q.answerType === "radio" || q.answerType === "checkbox") {
            ...
            (_a = q.answerOptions) === null || _a === void 0 ? void 0 : _a.forEach((option, optIndex) => {
                questionHtml += `
...
function calculateQuizResults() {
    ...
    quizCards.forEach((card, index) => {
        ...
        const questionText = ((_b = (_a = card.querySelector('p')) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.slice(3)) || '';
        let userAnswer = '';
        let isCorrect = false;
...
function submitQuiz() {
    ...
    questions.forEach(card => {
        const resultFeedback = card.querySelector('.result-feedback');
